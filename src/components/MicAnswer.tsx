...
export default function MicAnswer({
    ...
    async function start() {
        const { analyser, cleanup } = await startMicAnalyser({
            ...
            // NEW: gentle dynamics control
            compressor: true,
            compThreshold: -24,  // start compressing above -24 dBFS
            compKnee: 6,         // soft knee
            compRatio: 4,        // moderate compression
            compAttack: 0.003,   // ~3ms
            compRelease: 0.25,   // 250ms
            preGainDb: 0,        // bump if your input is very quiet (e.g., +6)
        });
